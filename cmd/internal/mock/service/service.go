...
func (m *MockClient) GetFollowing() (types.FollowingUsers, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFollowing")
	ret0, _ := ret[0].(types.FollowingUsers)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetFollowing indicates an expected call of GetFollowing
func (mr *MockClientMockRecorder) GetFollowing() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFollowing", reflect.TypeOf((*MockClient)(nil).GetFollowing))
}
